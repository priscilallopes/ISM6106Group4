...
class DAL:
    ...
    # ------------------------------------------------------
    # HUMIDITY-ONLY PUBLIC METHOD  (your controller calls this)
    # ------------------------------------------------------
    def postHumidity(self, humidity, sensor_id=203):
        """
        Creates a correct payload for humidity-only Pico.
        All other values become NULL.
        """
