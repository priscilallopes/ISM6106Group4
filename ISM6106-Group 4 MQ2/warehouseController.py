...
class WarehouseAlarmController:
    ...
    def _read_gas(self):
        ...
        # ------- GAS WARNING / ALARM (ratio-based) --------
        if ratio >= self.ALARM_GAS:
            self.gas_bad_count += 1

            if self.gas_bad_count == 1:
